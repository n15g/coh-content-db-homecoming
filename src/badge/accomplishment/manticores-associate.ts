...
export const ManticoresAssociate: IBadgeData = {
    ...
    links: [
        {title: "Manticore's Associate Badge", href: "https://paragonwiki.com/wiki/Manticore%27s_Associate_Badge"},
        {title: "Manticore's Betrayer Badge", href: "https://paragonwiki.com/wiki/Manticore%27s_Betrayer_Badge"}
    ],
    icons: [
