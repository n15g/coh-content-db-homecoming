...
export const WeaponMaster: IBadgeData = {
    ...
    links: [
        {title: "Weapon Master Badge", href: "https://paragonwiki.com/wiki/Weapon_Master_Badge"},
        {title: "Warrior Princess Badge", href: "https://paragonwiki.com/wiki/Warrior_Princess_Badge"}
    ],
    icons: [
