...
export const HonoraryPeacebringer: IBadgeData = {
    ...
    links: [
        {title: "Honorary Peacebringer Badge", href: "https://paragonwiki.com/wiki/Honorary_Peacebringer_Badge"},
        {title: "Alien Fighter Badge", href: "https://paragonwiki.com/wiki/Alien_Fighter_Badge"}
    ],
    icons: [
