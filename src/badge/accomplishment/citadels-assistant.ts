...
export const CitadelsAssistant: IBadgeData = {
    ...
    links: [
        {title: "Citadel's Assistant Badge", href: "https://paragonwiki.com/wiki/Citadel%27s_Assistant_Badge"},
        {title: "Citadel's Betrayer Badge", href: "https://paragonwiki.com/wiki/Citadel%27s_Betrayer_Badge"}
    ],
    icons: [
