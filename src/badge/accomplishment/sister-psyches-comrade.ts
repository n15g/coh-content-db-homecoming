...
export const SisterPsychesComrade: IBadgeData = {
    ...
    links: [
        {title: "Sister Psyche's Comrade Badge", href: "https://paragonwiki.com/wiki/Sister_Psyche%27s_Comrade_Badge"},
        {title: "Sister Psyche's Betrayer Badge", href: "https://paragonwiki.com/wiki/Sister_Psyche%27s_Betrayer_Badge"}
    ],
    icons: [
