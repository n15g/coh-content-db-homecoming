...
export const PlagueStopper: IBadgeData = {
    ...
    links: [
        {title: "Plague Stopper Badge", href: "https://paragonwiki.com/wiki/Plague_Stopper_Badge"},
        {title: "Deadly Virus Badge", href: "https://paragonwiki.com/wiki/Deadly_Virus_Badge"}
    ],
    icons: [
