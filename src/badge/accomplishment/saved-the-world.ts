...
export const SavedTheWorld: IBadgeData = {
    ...
    links: [
        {title: "Saved the World Badge", href: "https://paragonwiki.com/wiki/Saved_the_World_Badge"},
        {title: "Saved the World... For Later Badge", href: "https://paragonwiki.com/wiki/Saved_the_World..._For_Later_Badge"}
    ],
    icons: [
