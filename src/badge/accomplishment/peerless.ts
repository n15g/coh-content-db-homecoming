...
export const Peerless: IBadgeData = {
    ...
    links: [
        {title: "Peerless Badge", href: "https://paragonwiki.com/wiki/Peerless_Badge"},
        {title: "Recluse's Rival Badge", href: "https://paragonwiki.com/wiki/Recluse%27s_Rival_Badge"}
    ],
    icons: [
