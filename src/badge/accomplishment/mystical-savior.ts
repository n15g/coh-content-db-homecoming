...
export const MysticalSavior: IBadgeData = {
    ...
    links: [
        {title: "Mystical Savior Badge", href: "https://paragonwiki.com/wiki/Mystical_Savior_Badge"},
        {title: "Mystical Adept Badge", href: "https://paragonwiki.com/wiki/Mystical_Adept_Badge"}
    ],
    icons: [
