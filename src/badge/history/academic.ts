    ...
    partials: [
        {
            ...
            location: [-1904.0, 4.0, -7229],
            inscription: "In 1945, six members of the Freedom Phalanx met on Peregrine Island to save the world." +
        ...
        },
        {
            ...
            inscription: "On this site, Statesman and Maiden Justice battled a horde of Nemesis's strange steam-powered robots." +
        ...
        },
        {
            ...
            inscription: "In 1945, the Freedom Phalanx was determined to thwart Nemesis's campaign to wrest control of the U.S. Paragon City was one of the many major metropolises Nemesis had" +
                " infected with his strange poison gas. The hero known as the Dark Watcher knew that he had to find the source of the gas." +
                " Using his powers of extra-sensory perception, the Dark Watcher journeyed into the bowels of the city." +
            ...
            notes: "This plaque is in the Abandoned Sewer Network on the left side of the corridor that marks the entrance to Steel Canyon Sector." +
                " It is roughly 800 yards west of the Steel Canyon Sewer network entrance." +
                " Note that if you go in the regular Sewer Network the rooms will all look the same and you can reach the coordinates below, but the plaque is absent.",
            vidiotMapKey: "1"
        }
    ]
};
