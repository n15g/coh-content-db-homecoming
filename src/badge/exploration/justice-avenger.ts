...
export const JusticeAvenger: IBadgeData = {
    ...
    links: [
        {title: "Justice Avenger Badge", href: "https://paragonwiki.com/wiki/Justice_Avenger_Badge"},
        {title: "Social Climber Badge", href: "https://paragonwiki.com/wiki/Social_Climber_Badge"}
    ],
