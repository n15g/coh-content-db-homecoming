...
export const BroadShoulders: IBadgeData = {
    ...
    notes: "The Broad Shoulders Badge marker is located at the base of the meteor monument just northwest of the inset corner south of the hero base in [map:${SirensCall.key}].",
