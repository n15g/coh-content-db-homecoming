...
The marker is on a ledge on the large tower in the center of the zone. It is located on the south face of the tower just above the large Arachnos logo.`,
    links: [
        {title: "Master of the Airwaves Badge", href: "https://paragonwiki.com/wiki/Master_of_the_Airwaves_Badge"},
        {title: "Mistress of the Airwaves Badge", href: "https://paragonwiki.com/wiki/Mistress_of_the_Airwaves_Badge"}
    ],
