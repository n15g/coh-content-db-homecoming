...
export const Luscious: IBadgeData = {
    ...
    notes: "The Luscious Badge is located in Bloody Lane neighborhood of the Rikti War Zone, 90 yds west of the Bloody Lane neighborhood marker.",
    links: [
        {title: "Luscious Badge", href: "https://paragonwiki.com/wiki/Luscious_Badge"},
