...
export const Politician: IBadgeData = {
    ...
    notes: "The Politician Badge is located in the [map:${SirensCall.key}] zone to the right (east) of the doorway of the building immediately south of the hero base.",
