...
export const HeroCorpsInsider: IBadgeData = {
    ...
    links: [
        {title: "Hero Corps Insider Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Hero_Corps_Insider_Badge"},
        {title: "Hero Corps Infiltrator Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Hero_Corps_Infiltrator_Badge"}
    ],
