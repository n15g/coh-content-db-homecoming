...
Go now and strike the final blow that will confirm, once and for all, that the defenders of Primal Earth are not to be trifled with.`
    ...
    links: [
        {title: "Lord of Storms Badge", href: "https://paragonwiki.com/wiki/Lord_of_Storms_Badge"},
        {title: "Lady of Storms Badge", href: "https://paragonwiki.com/wiki/Lady_of_Storms_Badge"}
    ],
