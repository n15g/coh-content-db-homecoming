...
export const UseMightForRight: IBadgeData = {
    ...
    links: [
        {title: "Use Might for Right Badge", href: "https://paragonwiki.com/wiki/Use_Might_for_Right_Badge"},
        {title: "Rookie's Mistake", href: "https://paragonwiki.com/wiki/Rookie%27s_Mistake_Badge"}
    ],
