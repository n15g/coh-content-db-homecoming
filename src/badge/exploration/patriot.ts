...
export const Patriot: IBadgeData = {
    ...
    links: [
        {title: "Patriot Badge", href: "https://paragonwiki.com/wiki/Patriot_Badge"},
        {title: "International Spy Badge", href: "https://paragonwiki.com/wiki/International_Spy_Badge"}
    ],
