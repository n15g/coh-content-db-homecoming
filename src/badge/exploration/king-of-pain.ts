...
export const KingOfPain: IBadgeData = {
    ...
    links: [
        {title: "King of Pain Badge", href: "https://paragonwiki.com/wiki/King_of_Pain_Badge"},
        {title: "Queen of Pain Badge", href: "https://paragonwiki.com/wiki/Queen_of_Pain_Badge"}
    ],
