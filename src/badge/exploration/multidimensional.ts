...
export const Multidimensional: IBadgeData = {
    ...
    notes: "This badge is awarded for spending any amount of time on the mission map that appears in either of the Hydra missions from [Tina Macintyre](https://hcwiki.cityofheroes.dev/wiki/Tina_Macintyre)," +
        " or the Hydra mission from [Unai Kemen](https://hcwiki.cityofheroes.dev/wiki/Unai_Kemen).\n" +
        "\n" +
        "The badge is awarded after a random period of time while on the map, or will be rewarded immediately if you leave the map.",
    links: [
        {title: "Multidimensional Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Multidimensional_Badge"}
    ],
