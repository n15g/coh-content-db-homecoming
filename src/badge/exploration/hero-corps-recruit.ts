...
export const HeroCorpsRecruit: IBadgeData = {
    ...
    links: [
        {title: "Hero Corps Recruit Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Hero_Corps_Recruit_Badge"},
        {title: "Hero Corps Reject Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Hero_Corps_Reject_Badge"}
    ],
