...
export const Undammed: IBadgeData = {
    ...
    notes: "Located at the top right (northeast) corner of a building in a canyon on the east side of the zone between the borders of the Aftershock and Overflow neighborhoods of Faultline.",
    links: [
        {title: "Undammed Badge", href: "https://paragonwiki.com/wiki/Undammed_Badge"},
