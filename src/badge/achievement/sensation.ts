...
export const Sensation: IBadgeData = {
    ...
    links: [
        {title: "Sensation Badge", href: "https://paragonwiki.com/wiki/Sensation_Badge"},
        {title: "Mr. Big Badge", href: "https://paragonwiki.com/wiki/Mr._Big_Badge"},
        {title: "Ms. Big Badge", href: "https://paragonwiki.com/wiki/Ms._Big_Badge"},
        {title: "Acclaimed Badge", href: "https://paragonwiki.com/wiki/Acclaimed_Badge"}
    ],
    icons: [
