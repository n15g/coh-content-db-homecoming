...
export const Tough: IBadgeData = {
    ...
    links: [
        {title: "Tough Badge", href: "https://paragonwiki.com/wiki/Tough_Badge"},
        {title: "Stoic Badge", href: "https://paragonwiki.com/wiki/Stoic_Badge"},
        {title: "Slammer Badge", href: "https://paragonwiki.com/wiki/Slammer_Badge"}
    ],
    icons: [
