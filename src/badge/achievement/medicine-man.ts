...
export const MedicineMan: IBadgeData = {
    ...
    links: [
        {title: "Medicine Man Badge", href: "https://paragonwiki.com/wiki/Medicine_Man_Badge"},
        {title: "Medicine Woman Badge", href: "https://paragonwiki.com/wiki/Medicine_Woman_Badge"},
        {title: "Savior Badge", href: "https://paragonwiki.com/wiki/Savior_Badge"}
    ],
    icons: [
