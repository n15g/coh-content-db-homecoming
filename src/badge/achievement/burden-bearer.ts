...
export const BurdenBearer: IBadgeData = {
    ...
    links: [
        {title: "Burden Bearer Badge", href: "https://paragonwiki.com/wiki/Burden_Bearer_Badge"},
        {title: "Arm's Length Badge", href: "https://paragonwiki.com/wiki/Arm%27s_Length_Badge"}
    ],
    icons: [
