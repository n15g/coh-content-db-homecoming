...
export const GrassIsMeaner: IBadgeData = {
    ...
    links: [
        {title: "Grass Is Meaner Badge", href: "https://paragonwiki.com/wiki/Grass_Is_Meaner_Badge"},
        {title: "Grass Is Greener Badge", href: "https://paragonwiki.com/wiki/Grass_Is_Greener_Badge"}
    ],
    icons: [
