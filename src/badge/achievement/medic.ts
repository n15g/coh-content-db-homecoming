...
export const Medic: IBadgeData = {
    ...
    links: [
        {title: "Medic Badge", href: "https://paragonwiki.com/wiki/Medic_Badge"},
        {title: "Fixer Badge", href: "https://paragonwiki.com/wiki/Fixer_Badge"},
        {title: "Do Gooder Badge", href: "https://paragonwiki.com/wiki/Do_Gooder_Badge"}
    ],
    icons: [
