...
export const Celebrity: IBadgeData = {
    ...
    links: [
        {title: "Celebrity Badge", href: "https://paragonwiki.com/wiki/Celebrity_Badge"},
        {title: "Bling Badge", href: "https://paragonwiki.com/wiki/Bling_Badge"},
        {title: "Who's Who Badge", href: "https://paragonwiki.com/wiki/Who%27s_Who_Badge"}
    ],
    icons: [
