...
export const PumpkinMaster: IBadgeData = {
    ...
    links: [
        {title: "Pumpkin Master Badge", href: "https://paragonwiki.com/wiki/Pumpkin_Master_Badge"},
        {title: "Pumpkin Mistress Badge", href: "https://paragonwiki.com/wiki/Pumpkin_Mistress_Badge"}
    ],
    icons: [
