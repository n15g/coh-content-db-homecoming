...
export const PositronsPal: IBadgeData = {
    ...
    links: [
        {title: "Positron's Pal Badge", href: "https://paragonwiki.com/wiki/Positron%27s_Pal_Badge"},
        {title: "Positron's Nemesis Badge", href: "https://paragonwiki.com/wiki/Positron%27s_Nemesis_Badge"}
    ],
    icons: [
