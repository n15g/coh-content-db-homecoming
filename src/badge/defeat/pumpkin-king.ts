...
export const PumpkinKing: IBadgeData = {
    ...
    links: [
        {title: "Pumpkin King Badge", href: "https://paragonwiki.com/wiki/Pumpkin_King_Badge"},
        {title: "Pumpkin Queen Badge", href: "https://paragonwiki.com/wiki/Pumpkin_Queen_Badge"}
    ],
    icons: [
