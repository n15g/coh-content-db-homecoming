...
export const Weatherman: IBadgeData = {
    ...
    links: [
        {title: "Weatherman Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Weatherman_Badge"},
        {title: "Weathergirl Badge", href: "https://hcwiki.cityofheroes.dev/wiki/Weathergirl_Badge"}
    ],
    icons: [
