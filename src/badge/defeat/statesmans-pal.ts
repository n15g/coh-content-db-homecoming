...
export const StatesmansPal: IBadgeData = {
    ...
    links: [
        {title: "Statesman's Pal Badge", href: "https://paragonwiki.com/wiki/Statesman%27s_Pal_Badge"},
        {title: "Praetoria's Bane Badge", href: "https://paragonwiki.com/wiki/Praetoria%27s_Bane_Badge"}
    ],
    icons: [
