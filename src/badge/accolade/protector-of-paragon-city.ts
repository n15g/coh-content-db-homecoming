...
export const ProtectorOfParagonCity: IBadgeData = {
    ...
    badgeText: [
        {value: `You have shown true dedication to the protection of Paragon City, without sacrificing the morals that the city is founded and established on.`},
    ],
    ...
    links: [
        ...
        {title: "Traitor to Paragon City Badge", href: "https://homecoming.wiki/wiki/Protector_of_Paragon_City_Badge"}
    ],
    icons: [
