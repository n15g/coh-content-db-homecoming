...
export const AntiArachnosActivist: IBadgeData = {
    ...
    links: [
        {title: "Anti-Arachnos Activist Badge", href: "https://paragonwiki.com/wiki/Anti-Arachnos_Activist_Badge"},
        {title: "Web Weaver Badge", href: "https://paragonwiki.com/wiki/Web_Weaver_Badge"}
    ],
    icons: [
