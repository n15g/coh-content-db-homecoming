...
export const Uninsurable: IBadgeData = {
    ...
    links: [
        {title: "Uninsurable Badge", href: "https://paragonwiki.com/wiki/Uninsurable_Badge"},
        {title: "Force of Nature Badge", href: "https://paragonwiki.com/wiki/Force_of_Nature_Badge"}
    ],
    icons: [
