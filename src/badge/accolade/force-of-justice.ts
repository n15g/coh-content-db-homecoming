...
export const ForceOfJustice: IBadgeData = {
    ...
    links: [
        {title: "Force of Justice Badge", href: "https://paragonwiki.com/wiki/Force_of_Justice_Badge"},
        {title: "Force of Injustice Badge", href: "https://paragonwiki.com/wiki/Force_of_Injustice_Badge"}
    ],
    icons: [
