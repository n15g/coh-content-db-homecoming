...
export const BlockadeRunner: IBadgeData = {
    ...
    badgeText: [
        ...
        {type: Alternate.V, value: `Your masterful knowledge of the Black Market coupled with knowing where to get the best merchandise has made you a master of the Black Market.  While logged out near Docks or near the Black Market you will earn tokens that will grant you discount when crafting inventions.`}
    ],
    notes: `Earn the [badge:marketeer] and [badge:smuggler] Day Jobs`,
    links: [
        {title: "Blockade Runner Badge", href: "https://paragonwiki.com/wiki/Blockade_Runner_Badge"},
        {title: "Profiteer Badge", href: "https://paragonwiki.com/wiki/Profiteer_Badge"}
    ],
    icons: [
