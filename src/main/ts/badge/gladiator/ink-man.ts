...
export const InkMan: BadgeData = {
  ...
  notes: `Level 30-40 Eagle, Serpent, and Tiger Blue Ink Men count, and all level 50-54 Blue Ink Men count. Level 30-40 Dragon Blue Ink Men don't count, due to a likely oversight in badges.bin.`,
  links: [
