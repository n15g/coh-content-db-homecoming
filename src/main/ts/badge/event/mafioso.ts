...
export const Mafioso: IBadgeData = {
    ...
    badgeText: [
        {value: `You've relived the past by defeating 25 of the old school Family found during the City of Heroes Anniversary Event.`},
    ],
    acquisition: `Defeat 25 old school Family spawned from time capsules during the anniversary event.`,
    links: [
        {title: "Mafioso Badge", href: "https://homecoming.wiki/wiki/Mafioso_Badge"}
    ],
