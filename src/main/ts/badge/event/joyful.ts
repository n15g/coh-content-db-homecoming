...
export const Joyful: BadgeData = {
  ...
  morality: 'all',
  badgeText: 'The power of the season finds you overcome with joy.',
  ...
  links: [
    { title: 'Joyful Badge', href: 'https://homecoming.wiki/wiki/Joyful_Badge' },
  ],
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/event/joyful.png',
}
