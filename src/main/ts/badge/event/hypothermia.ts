...
export const Hypothermia: BadgeData = {
  ...
  morality: 'all',
  badgeText: `It's that time of year again, when the temperature drops and it's a good idea to bundle up and stay warm. There are festivities to enjoy -- no time to let hypothermia put a damper on your celebration!`,
