...
export const ReadTheWentworthPamphletOnMrJonesBulletinBoard: MissionData = {
  ...
  levelRange: [10, 50],
  links: [{ title: `Read the Wentworth pamphlet on Mr. Jones' bulletin board`, href: `https://homecoming.wiki/wiki/Guidance_Counselor_Jones#Read_the_Wentworth_pamphlet_on_Mr._Jones'_bulletin_board` }],
}
