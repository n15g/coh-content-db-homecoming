  ...
  vidiotMaps: [
    {
      ...
      pointsOfInterest: [
        { pos: [295, 365], zoneKey: 'sewer-network' },
        { pos: [1113, 718], zoneKey: 'sewer-network' },
        { pos: [68, 1589], zoneKey: 'sewer-network' },
        { pos: [673, 1802], zoneKey: 'sewer-network' },
        { pos: [1430, 1407], zoneKey: 'sewer-network' },
