...
export const UseMightForRight: BadgeData = {
  ...
  notes: `Located in the Bayside Docks neighborhood of ${mapLink(PeregrineIsland)}, 33 yards northeast of Ghost Falcon, 360 yards Southwest of the Bayside Docks marker, and behind the Recluse's Victory PvP Recruiter.`,
  links: [
