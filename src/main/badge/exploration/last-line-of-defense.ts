...
export const LastLineOfDefense: BadgeData = {
  ...
  notes: `Located on top of the large hill in ${mapLink(TalosIsland)}, just northwest of the Ouroboros teleport beacon, 169 yards north of the Green Line station.`,
  links: [
