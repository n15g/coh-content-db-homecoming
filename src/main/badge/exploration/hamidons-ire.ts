...
The people who died here deserved what they got.`,
  ...
  notes: `Located in ${zoneLink(TheAbyss)}, 735 yards northeast of the ${zoneLink(Grandville)} transfer point, in a fenced pen of barrels in the northeast portion of the developed island.`,
  links: [
