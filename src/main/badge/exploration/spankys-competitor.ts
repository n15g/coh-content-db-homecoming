...
export const SpankysCompetitor: BadgeData = {
  ...
  loc: [-2417, 161, 7963],
  badgeText: 'This boardwalk was started some time ago by Robert Cooling, who was seeking to create an alternative to Spanky\'s Boardwalk on the other end of Talos, mainly because he hated'
