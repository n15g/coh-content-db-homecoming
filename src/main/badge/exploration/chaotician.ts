...
export const Chaotician: BadgeData = {
  ...
  notes: `Located in The Gaspee neighborhood of ${zoneLink(FoundersFalls)}. It is located in the water 90 yards east-southeast of The Gaspee marker in a northwest-southeast tunnel under the city block.
