...
export const EscapeArtist: BadgeData = {
  ...
  loc: [-679, -167, -208],
  notes: `In ${zoneLink(Faultline)}, halfway between Freight Lifts B and C, there is a crevasse to the north. The badge marker is at the end of the bottom of that crevasse.`,
  links: [
