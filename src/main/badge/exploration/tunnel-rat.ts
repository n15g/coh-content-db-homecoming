...
export const TunnelRat: BadgeData = {
  ...
  notes: `The Tunnel Rat badge is in ${mapLink(Warburg)}, located in the far eastern entrance of the WEB underground missile plant (the entrance/exit of chamber three).`,
