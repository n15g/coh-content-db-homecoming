...
export const Ghoulish: BadgeData = {
  ...
  notes: `The Ghoulish Badge is 185 yards east and slightly north of the Ground Zero neighborhood.

There is a small building with a tunnel through it over the stone walkway, the badge marker is inside that small building.`,
  links: [
