...
export const DocWhedon: BadgeData = {
  ...
  notes: `Located in ${zoneLink(PerezPark)} 292 yards due east of the Everett Lake and 216 yards north of the Gaiman Woods neighborhood markers. It is also about 145 yards southeast of the Amphitheater.`,
  links: [
