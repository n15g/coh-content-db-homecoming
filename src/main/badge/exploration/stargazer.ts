...
export const Stargazer: BadgeData = {
  ...
  badgeText: [{
    value: `
Throwing caution aside you reach the uppermost point of Night Ward.
Here, scattered spirits soar overhead like shooting stars in the night sky, forever doomed to the limbo of Night Ward as she drifts ever further from the land of the dead.`,
  ...
  notes: `Located in ${zoneLink(NightWard)}, in the City of Souls neighborhood, 433 yards NE of the map marker; at the top of the Night Ward version of the Westerman Building.`,
  links: [
