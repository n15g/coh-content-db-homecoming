...
export const UnwelcomeGuest: BadgeData = {
  ...
  loc: [-634, 1, 1437],
  badgeText: `This Council base has managed to maintain its foothold within Sharkhead despite numerous attacks from several groups. These days, the biggest threats are the 5th Column raids and exposing sleeper agents among Council ranks.`,
  notes: `
