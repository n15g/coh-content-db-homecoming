...
export const BoomtownRefugee: BadgeData = {
  ...
  loc: [1792, -59, -2944],
  badgeText: [{
    value: `The destruction of Baumton was a nightmare. Out of fear and desperation hundreds of its citizens fled into the relative safety of the Sewer Network.
...
sits own apart from the Rikti and not everyone who entered it ever returned.`,
  ...
  notes: `Located in ${zoneLink(AbandonedSewerNetwork)} 111 yards south of the Sewer Network transfer point in Boomtown Sector, in the middle of the metal walkway.`,
  links: [
