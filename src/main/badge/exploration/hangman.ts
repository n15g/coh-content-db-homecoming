...
export const Hangman: BadgeData = {
  ...
  notes: 'The Hangman Badge marker is located on a small rock outcropping at the very base of the northern wall of the zone, just off the western shore of the villain base in ${zoneLink(SirensCall)}.'
