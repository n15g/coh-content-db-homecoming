...
export const JunkyardDog: BadgeData = {
  ...
  notes: `The Junkyard Dog Badge is located in Heartbreak Ridge neighborhood of the ${mapLink(RiktiWarZone)}. It can be found 118 east of the Heartbreak Ridge zone marker.`,
  links: [
