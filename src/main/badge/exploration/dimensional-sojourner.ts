...
export const DimensionalSojourner: BadgeData = {
  ...
  notes: `Located in ${zoneLink(FirebaseZulu)} 179 yards NE of the Firebase Zulu marker, in the middle of the portals that provide transport to the other Shard zones.`,
  links: [
