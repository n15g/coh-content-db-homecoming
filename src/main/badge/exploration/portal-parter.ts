...
export const PortalParter: BadgeData = {
  ...
  notes: `Located on a small island, approx. 834 yards southwest of the ${zoneLink(TalosIsland)} Ferry, and the marker is located in the center of the grassy area, between the rock outcropping and the large electrical tower.`,
  links: [
