...
export const HumanNature: BadgeData = {
  ...
  loc: [-976, 227.8, 1390],
  notes: `Located in ${zoneLink(Cimerora)} in front of the doors of a building at the center of the northern edge of Castellum Quarter, 451 yards north of the Castellum Quarter neighborhood marker.`,
  links: [
