...
export const Traveler: BadgeData = {
  ...
  badgeText: [
    {
      alignment: 'H', value: `Your travels around both Paragon City and the Shadow Shard have become a full time job for you and have earned you the title of Traveler.
