  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, 326 yards due east of the entrance to the Sewer Network.`,
      vidiotMapKey: '7',
    },
    {
      key: 'alum-1',
      ...
      notes: `This plaque is in ${mapLink(Croatoa)}, 167 yards northeast of the Sunset Ridge neighborhood marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'alum-2',
      ...
      notes: `This plaque is in ${mapLink(Croatoa)}, 57 yards west of War Witch.`,
      vidiotMapKey: '2',
    },
    {
      key: 'alum-3',
    ...
    },
    {
      ...
      notes: `This plaque is in the Misty Wood neighborhood of ${mapLink(Croatoa)}, about 330 yards SSE of the Field Analyst.`,
      vidiotMapKey: '4',
    },
  ],
}
