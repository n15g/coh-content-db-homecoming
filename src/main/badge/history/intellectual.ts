  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, 72 yards north and slightly west of the Argosy Industrial neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'inte-1',
      ...
      notes: `This plaque is in ${mapLink(EchoGalaxyCity)}, 348 yards south of the Equinox neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'inte-2',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, 602 yards northeast of the door to Independence Port, 333 yards northwest of The Gish marker, and 771 yards south of the Galaxy City entrance.`,
      vidiotMapKey: '3',
    },
    {
      key: 'inte-3',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, 83 yards west of the train line, next to a bunker entrance.`,
      vidiotMapKey: '4',
    },
    {
      key: 'inte-4',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, 269 yards northeast of the King Garment Works neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'inte-5',
      ...
      notes: `This plaque is in ${mapLink(PerezPark)}, 67 yards northeast of the old Galaxy City entrance or 288 yards south and a little west of the Boneyard neighborhood marker.`,
      vidiotMapKey: '5',
    },
  ],
}
