  ...
  requirements: [[
    {
      ...
      notes: `This Resistance propaganda is in ${mapLink(FirstWard)}, in the Free-Fire Zone neighborhood, 278 yards NNW of the map marker; along the northern wall of the zone in one of the Shadowed Paths.`,
      vidiotMapKey: '1',
    },
    {
      key: 'thel-1',
      ...
      notes: `This plaque is in ${mapLink(FirstWard)}, in the Free-Fire Zone neighborhood, 137 yards southwest of the Underground Imperial City Access map marker; at the edge of the ampitheater with the large star statue. It's just a few feet away from Jester.`,
      vidiotMapKey: '2',
    },
    {
      key: 'thel-2',
      ...
      notes: `This Resistance propaganda is in ${mapLink(FirstWard)}, in the Eltentown neighborhood, 81 yards SSW of Mistress of Fate; on the north face of the northwest corner of the wall surrounding the Survivor Compound.`,
      vidiotMapKey: '3',
    },
    {
      key: 'thel-3',
      ...
      notes: `This plaque is in ${mapLink(FirstWard)}, in the Free-Fire Zone neighborhood, 141 yards due west of the map marker; in front of the entrance to the CTA building.`,
      vidiotMapKey: '4',
    },
    {
      key: 'thel-4',
      ...
      notes: `This Resistance propaganda is in ${mapLink(FirstWard)}, in the Free-Fire Zone neighborhood, 69 yards ESE of the map marker; on the east wall of a long north-to-south plot.`,
      vidiotMapKey: '5',
    },
    {
      key: 'thel-5',
      ...
      notes: `This plaque is in ${mapLink(FirstWard)}, in the Free-Fire Zone neighborhood, 371 yards east and a bit south of the map marker; on the edge of a circular pathway in a park.`,
      vidiotMapKey: '6',
    },
    {
      key: 'thel-6',
      ...
      notes: `This plaque is in ${mapLink(FirstWard)}, in the Mercyview neighborhood, 361 yards NW of Seed Hunter; in the rubble on the south side of the collapsed bridge.`,
      vidiotMapKey: '7',
    },
    {
      key: 'thel-7',
      ...
      notes: `This plaque is in ${mapLink(FirstWard)}, in the Mercyview neighborhood, 70 yards north of Seed Hunter; on the gate just north of the Chapel of Enduring Light.`,
      vidiotMapKey: '8',
    },
    {
      key: 'thel-8',
      ...
      notes: `This Resistance propaganda is in ${mapLink(FirstWard)}, in the Mercyview neighborhood, 69 yards SSW of the Vendor; on the southern face of a destroyed, wall-like structure.`,
      vidiotMapKey: '9',
    },
    {
      key: 'thel-9',
