  ...
  requirements: [
    {
      ...
      notes: `This plaque is in ${zoneLink(TalosIsland)}, at the base of the statue of Talos, behind its left heel.`,
      vidiotMapKey: '1',
    },
    {
      key: 'auth-1',
      ...
      notes: `This plaque is in ${zoneLink(IndependencePort)}, at the north end of Valor Bridge, 180 yards south of the Valor Bridge marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'auth-2',
      ...
      notes: `This plaque is in ${zoneLink(IndependencePort)}, along the road west of Icon, 188 yards due west of the Tailor shop.`,
      vidiotMapKey: '2',
    },
    {
      key: 'auth-3',
      ...
      notes: `This plaque is in ${zoneLink(EchoDarkAstoria)}, approximately 178 yards east-southeast from the Toffet Terrace marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'auth-4',
      ...
      notes: `This plaque is in ${zoneLink(TerraVolta)}, 300 yards east by northeast from the Terra Volta Reactor marker.`,
      vidiotMapKey: '1',
    },
  ],
}
