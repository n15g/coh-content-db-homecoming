  ...
  requirements: [[
    {
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, 7 feet north of the Prometheus Park neighborhood marker, on the overpass overlooking a lake. It is also 112 feet west and slightly north of the Fort Trident marker.`,
      vidiotMapKey: '6',
    },
    {
      key: 'digg-1',
      ...
      notes: `This plaque is in ${mapLink(TheHollows)}, 196 yards south of the Cherry Hills neighborhood marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'digg-2',
      ...
      notes: `This plaque is in ${mapLink(TheHollows)}, 740 yards southeast of the Four Seasons neighborhood marker.`,
      vidiotMapKey: '2',
    },
    {
      key: 'digg-3',
      ...
      notes: `This plaque is in ${mapLink(TheHollows)}, 571 yards south of the Cherry Hills neighborhood marker.`,
      vidiotMapKey: '3',
    },
    {
      key: 'digg-4',
      ...
      notes: `This plaque is in ${mapLink(TheHollows)}, 571 yards east and slightly south of the Skyway City Entrance marker and 714 yards due south of the Red River Marker.`,
      vidiotMapKey: '4',
    },
  ]],
}
