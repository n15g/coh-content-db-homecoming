  ...
  requirements: [[
    {
      ...
      notes: `This plaque is in ${mapLink(TalosIsland)}, on the dock next to the ferry to Striga Isle.`,
      vidiotMapKey: '5',
    },
    {
      key: 'ghos-1',
      ...
      notes: `This plaque is in ${mapLink(StrigaIsle)}, 707 yards due north of the Port Noble neighborhood marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'ghos-2',
      ...
      notes: `This plaque is in ${mapLink(StrigaIsle)}, 137 yards east-southeast from the Bonny Morass neighborhood marker and 254 yards from The Wolf's Throat neighborhood marker on a straight line between them.`,
      vidiotMapKey: '2',
    },
    {
      key: 'ghos-3',
      ...
      notes: `This plaque is in ${mapLink(StrigaIsle)}, 330 yards due west of Ravenstorm.`,
      vidiotMapKey: '3',
    },
    {
      key: 'ghos-4',
      ...
      notes: `This plaque is in ${mapLink(StrigaIsle)}, 490 yards due south of Ravenstorm.`,
      vidiotMapKey: '4',
    },
  ]],
}
