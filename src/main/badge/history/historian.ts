  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(TalosIsland)}, 226 yards East of the Paragon City Monorail marker.`,
      vidiotMapKey: '4',
    },
    {
      key: 'hist-1',
      ...
      notes: `This plaque is in ${mapLink(IndependencePort)}, located on the southeast rock outcropping of Power Island. It's 742 yards from the Justice Quay marker and 843 yards southeast from the Terra Volta marker.`,
      vidiotMapKey: '4',
    },
    {
      key: 'hist-2',
      ...
      notes: `This plaque is in ${mapLink(EchoDarkAstoria)}, approximately 456 yds NW of Moth marker and 586 NE of Barca Plaza marker.`,
      vidiotMapKey: '4',
    },
    {
      key: 'hist-3',
      ...
      notes: `This plaque is in ${mapLink(TerraVolta)}, approximately 156 yds East of Rogers Industries marker along fence south side of road.`,
      vidiotMapKey: '3',
    },
    {
      key: 'hist-4',
      ...
      notes: `This plaque is in ${mapLink(TerraVolta)}, approximately 366 yds NW of Challanger Technology marker.`,
      vidiotMapKey: '4',
    },
  ],
}
