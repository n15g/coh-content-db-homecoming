  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(TalosIsland)}, 47 ft due west of the Ithaca Island marker.`,
      vidiotMapKey: '2',
    },
    {
      key: 'rese-1',
      ...
      notes: `This plaque is in ${mapLink(TalosIsland)}, 118 yds due east of the New Corinth marker.`,
      vidiotMapKey: '3',
    },
    {
      key: 'rese-2',
      ...
      notes: `This plaque is in ${mapLink(IndependencePort)}, 263 yds south by southeast of the Justice Quay marker.`,
      vidiotMapKey: '3',
    },
    {
      key: 'rese-3',
      ...
      notes: `This plaque is in ${mapLink(EchoDarkAstoria)}, 533 yds due north of the Romero Heights marker.`,
      vidiotMapKey: '2',
    },
    {
      key: 'rese-4',
      ...
      notes: `This plaque is in ${mapLink(EchoDarkAstoria)}, 242 yds west of the Romero Heights marker.`,
      vidiotMapKey: '3',
    },
    {
      key: 'rese-5',
      ...
      notes: `This plaque is in ${mapLink(TerraVolta)}, 352 yds west-southwest of the Coroman Manufacturing marker.`,
      vidiotMapKey: '2',
    },
  ],
}
