...
export const Bicentennial: BadgeData = {
  ...
  requirements: [[
    ...
    },
    {
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, roughly 85 yards southeast of the Prometheus Park neighborhood marker.`,
      vidiotMapKey: '9',
    },
    {
      key: 'bicn-2',
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, roughly 502 yards north-northeast of the Hyperion Way neighborhood marker.`,
      vidiotMapKey: '10',
    },
    {
      key: 'bicn-3',
      ...
      notes: `This plaque is in ${mapLink(Brickstown)}, roughly 53 yards southeast of the Seven Gates neighborhood marker.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-4',
      ...
      notes: `This plaque is in ${mapLink(FoundersFalls)}, roughly 271 yards west-southwest of the Hutchinson Park neighborhood marker.`,
      vidiotMapKey: '3',
    },
    {
      key: 'bicn-5',
      ...
      notes: `This plaque is in ${mapLink(FoundersFalls)}, roughly 204 yards east of The Red River neighborhood marker.`,
      vidiotMapKey: '4',
    },
    {
      key: 'bicn-6',
      ...
      notes: `This plaque is in ${mapLink(IndependencePort)}, roughly 406 yards northeast of the Justice Quay neighborhood marker, near the bottom of the ramp into the tram station.`,
      vidiotMapKey: '5',
    },
    {
      key: 'bicn-7',
      ...
      notes: `This plaque is in ${mapLink(IndependencePort)}, roughly 353 yards north of the Crey Cove neighborhood marker.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-8',
      ...
      notes: `This plaque is in ${mapLink(KallistiWharf)}, roughly 106 yards northeast of the Blackwing Headquarters neighborhood marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'bicn-9',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, roughly 237 yards north of the Freedom Plaza neighborhood marker, on a short wall in front of Blue Steel.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-10',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, roughly 190 yards north-northwest of the Industrial Avenue neighborhood marker, in front of Crowne Memorial Hospital.`,
      vidiotMapKey: '7',
    },
    {
      key: 'bicn-11',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, roughly 246 yards southeast of the High Park neighborhood marker.`,
      vidiotMapKey: '8',
    },
    {
      key: 'bicn-12',
      ...
      notes: `This plaque is in ${mapLink(PeregrineIsland)}, roughly 433 yards west-southwest of the Bayside Docks neighborhood marker, near the entrance ramp to the ferry.`,
      vidiotMapKey: '2',
    },
    {
      key: 'bicn-13',
      ...
      notes: `This plaque is in ${mapLink(PerezPark)}, roughly 349 yards south-southwest of the Boneyard neighborhood marker, on the wall next to the sealed Galaxy City gate.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-14',
      ...
      notes: `This plaque is in ${mapLink(SkywayCity)}, roughly 100 yards north-northeast of the Aerie Plaza neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'bicn-15',
      ...
      notes: `This plaque is in ${mapLink(SteelCanyon)}, roughly 390 yards east-southeast of the Gimry Ridge neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'bicn-16',
      ...
      notes: `This plaque is in ${mapLink(SteelCanyon)}, roughly 273 yards southeast of the Blyde Square neighborhood marker.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-17',
      ...
      notes: `This plaque is in ${mapLink(TalosIsland)}, roughly 761 yards southwest of the Eleusis neighborhood marker.`,
      vidiotMapKey: '6',
    },
    {
      key: 'bicn-18',
      ...
      notes: `This plaque is in ${mapLink(TerraVolta)}, roughly 174 yards north of the Coroman Manufacturing neighborhood marker, along the wall near the gate to Independence Port.`,
      vidiotMapKey: '5',
    },
    {
      key: 'bicn-19',
      ...
      notes: `This plaque is in ${mapLink(TheHollows)}, about 239 yards north of the Four Seasons neighborhood marker.`,
      vidiotMapKey: '5',
    },
  ]],
}
