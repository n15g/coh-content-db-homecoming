...
export const ArachnosRising: BadgeData = {
  ...
  requirements: [[
    ...
    },
    {
      ...
      notes: `This plaque is in ${mapLink(StMartial)}. Just south of Hardcase, there is a road. The plaque is hanging on the southern wall lining that road. It is 436 yards north and slightly west of the ferry.`,
      vidiotMapKey: '1',
    },
    {
      key: 'arac-2',
      ...
      notes: `This plaque is in ${mapLink(Warburg)}, 675 yards due southeast of the Arachnos flier to St. Martial. It is at the southern base of a tall radio tower.`,
      vidiotMapKey: '1',
    },
    {
      key: 'arac-3',
      ...
      notes: `This plaque is in ${mapLink(Grandville)}. It is located on the back side of the large tower in The Tangle neighborhood (though the plaque itself is in the Spider City neighborhood). Of the three large red windows on the back side of the tower, the plaque is on the left (eastern) side of the base of the rightmost (westernmost) window.`,
      vidiotMapKey: '1',
    },
    {
      key: 'arac-4',
      ...
      notes: `This plaque is in ${mapLink(Grandville)}, 340 yard due east of the Spider City marker. It is in The Gutter neighborhood, just outside the wall around Spider City.`,
      vidiotMapKey: '2',
    },
  ]],
}
