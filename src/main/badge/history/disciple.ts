  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(SteelCanyon)}, 244 yards south of the Sewer Network Entrance marker, in Fools Gold District.`,
      vidiotMapKey: '1',
    },
    {
      key: 'disc-1',
      ...
      notes: `This plaque is in ${mapLink(SkywayCity)}, 221 yds WNW of the marker for The Gruff.`,
      vidiotMapKey: '1',
    },
    {
      key: 'disc-2',
      ...
      notes: `This plaque is in ${mapLink(Boomtown)}, 497 yds north-northwest of Powderkeg marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'disc-3',
      ...
      notes: `This plaque is in ${mapLink(Boomtown)}, 319 yds south and a tad east of Powderkeg marker.`,
      vidiotMapKey: '2',
    },
    {
      key: 'disc-4',
      ...
      notes: `This plaque is in ${mapLink(Boomtown)}, 882 yds north-northwest of the entrance.`,
      vidiotMapKey: '3',
    },
    {
      key: 'disc-5',
      ...
      notes: `This plaque is in ${mapLink(Faultline)}, 180 yds north of the Aftershock marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'disc-6',
      ...
      notes: `This plaque is in ${mapLink(Faultline)}, 227 yds due west of the Aftershock marker.`,
      vidiotMapKey: '2',
    },
  ],
}
