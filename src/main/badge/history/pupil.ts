  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(AtlasPark)}, at the northwest corner of Atlas Plaza and just south of the Paragon City Monorail.`,
      vidiotMapKey: '1',
    },
    {
      key: 'pupi-1',
      ...
      notes: `This plaque is in ${mapLink(EchoGalaxyCity)}, 132 yards due north of the Arena, almost right on top of the Equinox neighborhood marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'pupi-2',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, 642 yards due south of the Galaxy City entrance, or 412 yards south-east of the High Park marker.`,
      vidiotMapKey: '1',
    },
    {
      key: 'pupi-3',
      ...
      notes: `This plaque is in ${mapLink(KingsRow)}, 188 yards southwest of Blue Steel.`,
      vidiotMapKey: '2',
    },
    {
      key: 'pupi-4',
      ...
      notes: `This plaque is in ${mapLink(PerezPark)}, 228 yards North of the Everett Lake Marker.`,
      vidiotMapKey: '1',
    },
  ],
}
