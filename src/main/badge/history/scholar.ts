  ...
  partials: [
    {
      ...
      notes: `This plaque is in ${mapLink(SteelCanyon)}, near the South Monorail station.`,
      vidiotMapKey: '4',
    },
    {
      key: 'schr-1',
      ...
      notes: `This plaque is in ${mapLink(SkywayCity)} at a rest stop just west of the Talos Island gate. It is on the wall, facing north, hidden in the shadows next to the restrooms. It is 158 yards west-southwest of the Talos Island gate.`,
      vidiotMapKey: '3',
    },
    {
      key: 'schr-2',
      ...
      notes: `This plaque is in ${mapLink(SkywayCity)}. It is facing south, on a wall along a road that is going down hill to the west. It is approximately 250 yards west of the Land of the Lost neighborhood marker.`,
      vidiotMapKey: '4',
    },
    {
      key: 'schr-3',
      ...
      notes: `This plaque is in ${mapLink(Boomtown)}, 195 yards due east of the The Fuse neighborhood marker.`,
      vidiotMapKey: '5',
    },
    {
      key: 'schr-4',
      ...
      notes: `This plaque is in ${mapLink(Faultline)}, 436 yards West of the Overbrook Medical Center.`,
      vidiotMapKey: '4',
    },
  ],
}
