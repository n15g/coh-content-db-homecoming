...
export const Trusting: BadgeData = {
  ...
  alignment: ['H'],
  badgeText: [
    { alignment: 'H', value: 'You\'ve handed the Malleus Mundi over to MAGI for safekeeping. You Hope.' },
    { alignment: 'V', value: 'Unfortunately MAGI didn\'t hold onto the Malleus Mundi for long, or you\'d know just where to make a quick score.' },
  ],
  ...
  icon: [{ value: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/event/trusting.png' }],
}
