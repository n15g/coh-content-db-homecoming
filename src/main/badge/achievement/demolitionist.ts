...
export const Demolitionist: BadgeData = {
  ...
  name: 'Demolitionist',
  morality: 'all',
  badgeText: 'You have helped place 10 bombs on the crashed Rikti ship in the Rikti War Zone.',
  ...
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/achievement/demolitionist.png',
}
