...
export const AlarmRaiser: BadgeData = {
  ...
  name: 'Alarm Raiser',
  morality: 'all',
  badgeText: 'Whether by chutzpah or ignorance, you managed to assault the Behavioral Adjustment Facility without ever disabling a single one of their guard towers.',
