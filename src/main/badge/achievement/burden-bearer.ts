...
export const BurdenBearer: BadgeData = {
  ...
  setTitle: { id: 1760 },
  name: [
    { alignment: 'H', value: 'Burden Bearer' },
    { alignment: 'V', value: 'Arm\'s Length' },
  ],
  alignment: ['H', 'V', 'P'],
  badgeText: [
    {
      alignment: 'H', value: 'Who needs the help of police drones? You let them sit on the sidelines and took care of the '
        + 'invasion yourself, while also making sure none of them were destroyed.',
    },
    {
      alignment: 'V', value: 'You kept the police drones de-activated while also ensuring none of them were destroyed during '
