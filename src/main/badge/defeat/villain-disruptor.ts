...
export const VillainDisruptor: BadgeData = {
  ...
  alignment: ['H'],
  badgeText: [
    { alignment: 'H', value: 'It doesn\'t matter who or where; you will stop anyone who threatens your city.' },
    {
      alignment: 'V', value: 'Having a reputation for beating down villains has actually helped more than hurt you in the '
        + 'Rogue Isles.',
    },
  ],
