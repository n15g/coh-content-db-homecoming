...
export const LoopHero: BadgeData = {
  ...
  notes: `Run the Troubled Times arc from Dr. Stribbling (Level 30-34, Arc 27.08 in Ouro, Vigilante) four times, choosing one of the four fates for Marcus below until all four choices have been made.
