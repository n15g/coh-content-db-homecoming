...
export const TrueNemesis: BadgeData = {
  ...
  notes: `The task set 'Nemesis Rex' begins with the 'Stop the battle between Nemesis Army factions and make sure no innocents get hurt' mission from level 40-44 contact Maxwell Christopher in ${zoneLink(FoundersFalls)}.
